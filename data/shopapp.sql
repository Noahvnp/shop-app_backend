...
('20250227040145-create-user.js'),
('20250227041919-create-category.js'),
('20250227043809-create-brand.js'),
('20250227043810-create-news.js'),
('20250227043820-create-banner.js'),
('20250227072228-create-order.js'),
('20250227073555-create-product.js'),
('20250227074623-create-order-detail.js'),
('20250227075728-create-banner-detail.js'),
('20250227080732-create-feedback.js'),
('20250227081619-create-news-detail.js');
...
--
ALTER TABLE `news_detail`
  ADD CONSTRAINT `news_detail_ibfk_1` FOREIGN KEY (`product_id`) REFERENCES `products` (`id`),
  ADD CONSTRAINT `news_detail_ibfk_2` FOREIGN KEY (`news_id`) REFERENCES `news` (`id`);
